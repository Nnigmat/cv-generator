var Print = (function () {
  var BASE_CSS = '<style>'
    ...
    + '.cv-sidebar-photo{width:70%;aspect-ratio:3/4;object-fit:cover;border-radius:4px;margin-bottom:18px;display:block;margin-left:auto;margin-right:auto}'
    + '.cv-sidebar-photo-placeholder{width:70%;aspect-ratio:3/4;background:#2e3d52;border-radius:4px;margin-bottom:18px;display:flex;align-items:center;justify-content:center;color:#6a7f9a;font-size:12px;margin-left:auto;margin-right:auto}'
